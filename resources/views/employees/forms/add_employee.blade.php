    ...
    <div @click.away="showAddUserModal = false" 
        ...
        <form action="#" method="POST">
            ...
            <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                ...
                <button type="button" @click="showAddUserModal = false" class="text-slate-400 hover:text-slate-600">
            ...
            <div class="p-8 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="branch" placeholder="e.g. Head Office / Makati" required
                           class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm transition-all">
                </div>
            </div>
