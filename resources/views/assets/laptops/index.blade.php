...
<body class="bg-slate-50 font-sans antialiased" x-data="{ showAddModal: false }">
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <button 
                        ...
                        class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm hover:bg-blue-700 transition-all active:scale-95">
                        + Add New Item
                    </button>
                </div>
    ...
    @include('assets.laptops.forms.add_laptop')
