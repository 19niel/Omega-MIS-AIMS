        ...
        <main class="flex-1">
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <a href="{{ route('assets.category', 'laptops') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-300 transition-all">
                    ...
                    <a href="{{ route('assets.category', 'pcs') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-300 transition-all">
                        <div class="flex items-start justify-between mb-4">
                    ...
                    <a href="{{ route('assets.category', 'flashdrives') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-300 transition-all">
                        <div class="flex items-start justify-between mb-4">
