    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1">
            <header class="h-16 border-b border-slate-200 bg-white flex items-center justify-between px-8">
                <h2 class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Asset Management</h2>
            </header>
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('assets.laptops') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-300 transition-all">
                        ...
                        <p class="text-sm text-slate-500 mt-1">Workstations and fleet devices.</p>
                    </a>

                    <a href="{{ route('assets.desktops') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-purple-300 transition-all">
                        <div class="flex items-start justify-between mb-4">
                        ...
                        <p class="text-sm text-slate-500 mt-1">All-in-ones and Tower units.</p>
                    </a>

                    <a href="{{ route('assets.monitors') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all">
                        <div class="flex items-start justify-between mb-4">
                            <div class="p-3 bg-emerald-50 text-emerald-600 rounded-xl group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="10" x="4" y="3" rx="2"/><path d="M12 13v4"/><path d="M8 21h8"/></svg>
                            </div>
                        </div>
                        <h3 class="text-lg font-bold text-slate-900">Monitors</h3>
                        <p class="text-sm text-slate-500 mt-1">Display units and dual-screen setups.</p>
                    </a>

                    <a href="{{ route('assets.peripherals') }}" class="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-orange-300 transition-all">
                        <div class="flex items-start justify-between mb-4">
                        ...
                        <p class="text-sm text-slate-500 mt-1">Keyboards, mice, and accessories.</p>
                    </a>
