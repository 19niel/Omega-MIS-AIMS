            ...
            <div class="p-8 space-y-8">
                ...
                <div class="bg-slate-50 p-4 rounded-xl border border-slate-200">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="col-span-1">
                            ...
                            <input type="text" name="cpu" placeholder="i7-12th Gen" class="w-full px-3 py-2 bg-white border border-slate-200 rounded-md text-sm outline-none focus:border-blue-500">
                        </div>
                        <div class="col-span-1">
                            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-1">RAM</label>
                            <input type="text" name="ram" placeholder="16GB DDR4" class="w-full px-3 py-2 bg-white border border-slate-200 rounded-md text-sm outline-none focus:border-blue-500">
                        </div>
                        <div class="col-span-1">
                            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-1">Storage</label>
                            <input type="text" name="storage" placeholder="512GB NVMe" class="w-full px-3 py-2 bg-white border border-slate-200 rounded-md text-sm outline-none focus:border-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="col-span-1">
                        ...
                        <select name="current_user" class="w-full px-4 py-2.5 bg-blue-50/50 border border-blue-100 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm appearance-none cursor-pointer">
                            <option value="">Select Employee...</option>
                            <option value="1">No Current User</option>
                            <option value="2">Nathaniel Pro Gamer (MIS)</option>
                            <option value="3">Marcus Sausa (IT)</option>
                            <option value="4">Demetrio Bidan (Admin)</option>
                        </select>
                    </div>
                    <div class="col-span-1">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="recent_owner" placeholder="Previous owner if any..." 
                               class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm outline-none">
                    </div>
                </div>

                <div>
                    <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Device Attachment (Photo)</label>
                    <div class="mt-1 flex justify-center px-6 pt-4 pb-5 border-2 border-slate-200 border-dashed rounded-xl hover:bg-slate-50 transition-colors cursor-pointer">
